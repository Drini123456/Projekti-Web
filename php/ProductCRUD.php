...
$ppicpath="Image"."/".$profilepic;
$sql=mysqli_query($con,"delete from produktet where ID=$rid");
unlink($ppicpath);
    ...
    <link rel="stylesheet" type="text/css" href="../css/style1.css">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h1>THIS IS THE PRODUCTS CRUD</h1><h1>Welcome <?php echo $_SESSION["username"] ?></h1>
                        <br>
...
<!--Fetch the Records -->
  ...
  <a href="read.php?viewid=<?php echo htmlentities ($row['ID']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            ...
                            <a href="ProductCRUD.php?delid=<?php echo ($row['ID']);?>&&ppic=<?php echo $row['Image'];?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                    <?php 
$cnt=$cnt+1;
